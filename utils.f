...
: SET_IN_9 					( -- )
	9 GPFSEL_ADDRESS 9 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER GPIO_BASE ! ;		\ We set GPIO 9 to INPUT
	
: SET_IN_10					( -- )
	10 GPFSEL_ADDRESS 10 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER GPIO_BASE ! ;		\ We set GPIO 10 to INPUT

: SET_ALT0_2					( -- )
	GPIO_BASE 2 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER 				\ We set GPIO 2 to ALT0
	100 OR GPIO_BASE ! ;
	
: SET_ALT0_3					( -- )
	GPIO_BASE 3 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER 				\ We set GPIO 3 to ALT0
	800 OR GPIO_BASE ! ;				
