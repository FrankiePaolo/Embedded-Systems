...
: SET_IN_9 					( -- )
	9 GPFSEL_ADDRESS 9 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER GPIO_BASE ! ;		\ We set GPIO 9 to IN
	
: SET_IN_10					( -- )
	10 GPFSEL_ADDRESS 10 GPFSEL_STARTING_BIT_POSITION 3 MASK_REGISTER GPIO_BASE ! ;		\ We set GPIO 10 to IN
